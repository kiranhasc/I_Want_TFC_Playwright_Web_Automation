...
import {verifyPauseAdForMicroDramaFlow,verifyPauseAdLiveContentPlaybackFlow,verifyPauseAdAbsenceForPremiumOrGmaFlow,verifyBillboardAdBannerVisibilityFlow,
...
verifyPauseAdNotDisplayedOnSkipIntroRecapGoLiveFlow,verifyPauseAdDisplaysForDifferentUsersFlow} from '../../src/businessFunction/ott-playback-bfs';
import testCaseData from '../../src/data/ott-test-cases.json';
import { verifyMidRailBannerAdlVisibility } from '../../src/businessFunction/ott-landing-bfs';
import { verifyPauseAdNoReappearWithin3SecFlow } from '../../src/businessFunction/ott-playback-bfs';
...
test.describe('Ads', () => {
    ...
    test('@Medium @D IW3-T3981: Verify pause ad is clickable by user interactions', async ({ page }) => {
        test.setTimeout(180000);
