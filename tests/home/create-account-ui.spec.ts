...
test.describe('Account creation UI', () => {
    test('IW3-T1849: Verify the UI/UX of the Create an account screen', async ({ page }) => {
...
test.describe('Authentication validation', () => {
    test('IW3-T1856: Verify error message is displayed when email and password fields are left empty', async ({ page }) => {
