...
import { verifyCreateAccountScreenUI, enterCreateAccountEmailOnly, submitCreateAccountInvalidCredentials, validateEditProfileNameFields, loginToOTT } from '../../src/businessFunction/ott-auth-bfs';
...
test.describe('Account creation UI', () => {
    test('@Low @D IW3-T1849: Verify the UI/UX of the Create an account screen', async ({ page }) => {
    ...
    test('@High @D IW3-T1848: Verify the navigation on tapping of Create Account', async ({ page }) => {
        const data = testCaseData['tc-auth-006-create-account-ui'];
        const result = await verifyCreateAccountScreenUI(page, {
            expectedHeading: data.expectedHeading,
            expectedEmailLabel: data.expectedEmailLabel,
    ...
    test('@High @D IW3-T1850: Verify the functionality of entering email id in the "Let\'s Get Started" screen', async ({ page }) => {
    ...
    test('@High @D IW3-T1855: Verify the error message on entering invalid email/phone number and password on the Email text field on Get Started screen', async ({ page }) => {
    ...
    test('@Low @D IW3-T1856: Verify error message is displayed when email and password fields are left empty', async ({ page }) => {
    ...
    test('@High @D IW3-T1846: Verify that user navigates to "Welcome to iWant" screen on entering the URL from Non-PH region', async ({ page }) => {
    ...
    test('@Low @D IW3-T1847: Verify the UI/UX of the "Welcome to iWant" screen', async ({ page }) => {
    ...
    test('@Low @D IW3-T1857: Verify the message displayed when new user try to login without registration', async ({ page }) => {
    ...
    test('@Low @D IW3-T1859: Verify the message displayed on entering invalid credentials during login', async ({ page }) => {
    ...
    test('@Low @D IW3-T1858: Verify the password visibility toggle', async ({ page }) => {
