...
import { navigateToShowDetailsFromShowsPage } from '../../src/businessFunction/ott-details-bfs';
...
test.describe('Shows content details navigation', () => {
  test(' @inprogress IW3-T1895: Verify the user navigates to content details page post tapping on Show contents from Shows page', async ({ page }) => {
